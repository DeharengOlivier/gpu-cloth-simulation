...
// Bind group 0 holds the camera uniform, shared by both render pipelines. It is
// the only group the pipeline layout provides: the simulated particle positions
// arrive as instanced vertex data (see InstanceInput below), not as a storage
// buffer read here.
